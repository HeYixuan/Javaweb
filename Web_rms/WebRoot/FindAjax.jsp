...
<body>
						...
						<div class="widget-content nopadding">
							...
							<form class="form-horizontal" method="post" action="#"
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="form-control" name="user.id" id="id"
											value="<s:property value='user.id'/>" placeholder="编号"
											readonly="readonly">
										<%-- <span style="color: #b94a48" id="UsernameMessage" class="help-inline"></span> --%>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="user.loginName" id="Username"
											value="<s:property value='user.loginName'/>" readonly="readonly" /> <span
											style="color: #b94a48" id="UsernameMessage"
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="user.email" id="Email"
											value="<s:property value='user.email'/>" /> <span
											style="color: #b94a48" id="EmailMessage" class="help-inline"></span>
									</div>
								</div>
								<div class="form-actions">
									<input type="button" id="btn" value="完善信息"
	...
	<script type="text/javascript" src="MyJS/Information.js"></script>
