						...
						validate : function(options) {
							...
							if (validator.settings.onsubmit) {
								...
								if (validator.settings.submitHandler) {
									inputsAndButtons.filter(":submit").click(
											function() {
					...
					$.validator,
					{
						...
						messages : {
							...
							date : "Please enter a valid date.",
							  ...
							  number: "Please enter a valid number.", digits:
						...
						attributeRules : function(element) {
							...
							for ( var method in $.validator.methods) {
								var value;
								// If .prop exists (jQuery >= 1.6), use it to
								// get true/false for required
								if (method === 'required'
										&& typeof $.fn.prop === 'function') {
						...
						methods : {
							...
							email : function(value, element) {
								...
								return this.optional(element)
								||/^(([a-z,A-Z,0-9_-]{6,11})@([a-z,A-Z]{2,4}|126|163|189)\.([a-z,A-Z]{2,3}))$/i
												.test(value);
							},
							...
							date : function(value, element) {
								return this.optional(element)
										|| /^[0-9]{4}-(((0[13578]|(10|12))-(0[1-9]|[1-2][0-9]|3[0-1]))|(02-(0[1-9]|[1-2][0-9]))|((0[469]|11)-(0[1-9]|[1-2][0-9]|30)))$/i
												.test(value);
							},
